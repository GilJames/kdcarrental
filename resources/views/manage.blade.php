...
<div class="uploadcontainer">  
  <form id="contact" action="{{route('car_details.store')}}" method="POST" enctype=multipart/form-data>
    ...
    <input placeholder="Car Seats" type="text" name="carseats"  required autofocus>
       ...
       <fieldset>   
    <input placeholder="Car History" type="text" name="carhistory"  required autofocus>
    </fieldset>
       <fieldset>   
    <input placeholder="Fuel Type" type="text" name="fueltype"  required autofocus>
    </fieldset>
       <fieldset>   
    <input placeholder="Car Type" type="text" name="cartype"  required autofocus>
    </fieldset>
