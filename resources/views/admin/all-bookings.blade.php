<div id="alltableParentClass" class="table-responsive {{ session('selectedOption') != 'all' ? 'd-none' : '' }}">
    @if (session('info'))
                ...
                @foreach ($all as $key => $book)
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                <a href="#" data-toggle="modal" title="View Details" data-target="#viewAllBook{{$book->id}}">
                        ...
                        @if ($book->status != 'reject')
                            <td>
                                ...
                                @if ($book->status == 'To_pay')
                                    <a href="#" class="btn btn-success btn-sm statusClick" style="padding: 5px 10px; font-size: 12px;" data-toggle="modal"
                                        data-target="#confirmModal{{ $book->id }}"
                                        id="confirmButton{{ $book->id }}">Confirm</a>
                                    <div class="modal fade" id="confirmModal{{ $book->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-success submitConfirm"
                                                        onclick="submitClick({{ $book->id }},'confirm', 'confirmModal{{ $book->id }}', 'bookingModel')">Confirm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <td>
                                <a href="#" class="btn btn-danger btn-sm statusClick" style="padding: 5px 10px; font-size: 12px;" data-toggle="modal"
                                    data-status="reject" data-target="#rejectModal{{ $book->id }}"
                                    id="rejectButton{{ $book->id }}">Reject
                                </a>


                                <div class="modal fade" data-status="rejected" id="rejectModal{{ $book->id }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-danger submitReject"
                                                    onclick="submitClick({{ $book->id }},'reject','rejectModal{{ $book->id }}','bookingModel')">Reject</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
