        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6" style=" padding-left: 3%">
                    <h3 class="page-title" style="text-align:Center;margin-bottom: 5%">Update Booking Form</h3>
                    <form action="{{ url('updateselfbooking') }}" method="POST">
                        @csrf
                        <div class="row formtype">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Cars List</label>
                                    <select class="form-control carListSelect" id="carList" name="admincars_idSelect">
                                        @foreach ($datas as $cr)
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control pickupdateInput" type="date" id="sel2"
                                        name="pickupdate"value="{{ $data->pickupdate }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control dropoffdateInput" type="date" id="sel2"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input type="text" class="form-control datetimepicker daytripInput" readonly
                                            disabled name="daytrip"value="{{ $data->daytrip }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control carPriceHere text-danger carPriceVal" readonly type="text"
                                        name="admincar_price" id="carprice" value="{{ $data->admincar->carprice }}">
